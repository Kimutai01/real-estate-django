...
class Apartment(models.Model):
    ...
    image = models.ImageField(default='default.jpg',
                              blank=True, null=True, upload_to='apartments')
...
class Room(models.Model):
    ...
    image = models.ImageField(default='default.jpg',
                              blank=True, null=True, upload_to='rooms',)
...
class Booking(models.Model):
    available_time = models.ForeignKey(
        AvailableTime, on_delete=models.CASCADE, null=True)
...
class Contract(models.Model):
    ...
    room = models.ForeignKey(Room, on_delete=models.CASCADE)
    start_date = models.DateField()
    agent_first_name = models.CharField(max_length=50, null=True, blank=True)
    agent_last_name = models.CharField(max_length=50, null=True, blank=True)
    tenant_first_name = models.CharField(max_length=50, null=True, blank=True)
    tenant_last_name = models.CharField(max_length=50, null=True, blank=True)
...
def delete_occupation(sender, instance, **kwargs):
    ...
    room.save()
    try:
        contract = Contract.objects.get(room=room, tenant=instance.tenant)
        contract.delete()
